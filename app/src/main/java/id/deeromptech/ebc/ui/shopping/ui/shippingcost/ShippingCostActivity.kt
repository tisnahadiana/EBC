...
import id.deeromptech.ebc.databinding.ActivityShippingCostBinding
import id.deeromptech.ebc.util.*

@AndroidEntryPoint
class ShippingCostActivity : AppCompatActivity() {

    private lateinit var binding: ActivityShippingCostBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityShippingCostBinding.inflate(layoutInflater)
    ...
    private fun checkedPostageFee() {
        ...
        if (strDestinationCity.isNotEmpty() && strOriginCity.isNotEmpty() && strCourier.isNotEmpty() && strWeight.isNotEmpty()) {
            ...
            ToastUtils.showMessage(this, getString(R.string.form_empty))
        }
    }
